...
namespace Communication
{
	...
	bool CCyUSBStream::SMRotOneDegFunction(double v_ddeg_x, bool v_bpositiveOrien_x, double v_ddeg_y, bool v_bpositiveOrien_y, bool v_bcali, vector<cv::Mat> &img_L_set, vector<cv::Mat> &img_R_set)
	{
		...
		if (v_bcali == true)
		{
			if (v_bpositiveOrien_x == true && v_bpositiveOrien_y == true)
			{
				SMRotOneDeg[4] = 0X00;//0000 0000
			}
			else if (v_bpositiveOrien_x == true && v_bpositiveOrien_y == false)
			{
				SMRotOneDeg[4] = 0X01;//0000 0001
			}
			else if (v_bpositiveOrien_x == false && v_bpositiveOrien_y == true)
			{
				SMRotOneDeg[4] = 0X04;//0000 0100
			}
			else if (v_bpositiveOrien_x == false && v_bpositiveOrien_y == false)
			{
				SMRotOneDeg[4] = 0X05;//0000 0101
			}
		...
		else 
		{
			if (v_bpositiveOrien_x == true && v_bpositiveOrien_y == true)
			{
				SMRotOneDeg[4] = 0X10;//0001 0000
			}
			else if (v_bpositiveOrien_x == true && v_bpositiveOrien_y == false)
			{
				SMRotOneDeg[4] = 0X11;//0001 0001
			}
			else if (v_bpositiveOrien_x == false && v_bpositiveOrien_y == true)
			{
				SMRotOneDeg[4] = 0X14;//0001 0100
			}
			else if (v_bpositiveOrien_x == false && v_bpositiveOrien_y == false)
			{
				SMRotOneDeg[4] = 0X15;//0001 0101
			}
