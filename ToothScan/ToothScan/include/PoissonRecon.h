...
public:
	...
	bool __declspec (dllexport) run_cpu(orth::MeshModel& mm, const int depth, const float error_threshold);

	bool __declspec (dllexport) run_cpu(vector<orth::MeshModel>& mms, orth::MeshModel& mm, const int depth, const float error_threshold);

	void __declspec (dllexport) RedundancyFilter_cpu(orth::MeshModel &model_target, orth::MeshModel &model_to_filt, double error_threshold);

	bool __declspec (dllexport) MergeWithoutRedundancy_cpu(orth::MeshModel &model_target, vector<orth::MeshModel> &models_to_merge, orth::MeshModel &model_merged, double error_threshold);
};
