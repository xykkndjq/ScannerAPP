...
static byte SMXEnable[5] = { 0xaa,0xbb,0x05,0x02,0x00 }; //使能
static byte SMXDisable[5] = { 0xaa,0xbb,0x05,0x02,0x01 }; //失能
static byte SMXRotOneDegPos[9] = { 0xaa,0xbb,0x09,0x02,0x02,0x00,0x00,0x00,0x00 }; //步进电机正转一个固定角度 deg = SMXRotOneDeg[5] * 256 + SMXRotOneDeg[6]
static byte SMXRotOneDegNeg[9] = { 0xaa,0xbb,0x09,0x02,0x02,0x01,0x00,0x00,0x00 }; //步进电机反转一个固定角度 deg = SMXRotOneDeg[5] * 256 + SMXRotOneDeg[6]
static byte SMXRotOneCirclePos[6] = { 0xaa,0xbb,0x06,0x02,0x03,0x00 }; //步进电机正转一圈
static byte SMXRotOneCircleNeg[6] = { 0xaa,0xbb,0x06,0x02,0x03,0x01 }; //步进电机反转一圈

static byte SMYEnable[5] = { 0xaa,0xbb,0x05,0x03,0x00 }; //使能
static byte SMYDisable[5] = { 0xaa,0xbb,0x05,0x03,0x01 }; //失能
static byte SMYRotOneDegPos[9] = { 0xaa,0xbb,0x09,0x03,0x02,0x00,0x00,0x00,0x00 }; //步进电机正转一个固定角度 deg = SMXRotOneDeg[5] * 256 + SMXRotOneDeg[6]
static byte SMYRotOneDegNeg[9] = { 0xaa,0xbb,0x09,0x03,0x02,0x01,0x00,0x00,0x00 }; //步进电机反转一个固定角度 deg = SMXRotOneDeg[5] * 256 + SMXRotOneDeg[6]
static byte SMYRotOneCirclePos[6] = { 0xaa,0xbb,0x06,0x03,0x03,0x00 }; //步进电机正转一圈
static byte SMYRotOneCircleNeg[6] = { 0xaa,0xbb,0x06,0x03,0x03,0x01 }; //步进电机反转一圈
